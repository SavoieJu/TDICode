    ...
    switch($action) {
        case 'insert':
          try{
            ...
            $response = $oControleur->insertNewRecetteAllergene($idRecette, $sNomRecette, $ingredients, $idEtudiant, $sprenomEtudiant, $sNomEtudiant, $idCoequipier, $sPrenomCoequipier, $sNomCoequipier);
